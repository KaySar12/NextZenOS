...
func GetConfig() Dropbox {
	dp := Dropbox{}
	dp.RootFolderID = ""
	dp.AuthUrl = "https://www.dropbox.com/oauth2/authorize?client_id=" + app_key + "&redirect_uri=https://nextzen-api.onrender.com/cloud&response_type=code&token_access_type=offline&state=${HOST}%2Fv1%2Frecover%2FDropbox&&force_reapprove=true&force_reauthentication=true"
	dp.AppKey = app_key
